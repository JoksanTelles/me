...
async function run() {
  ...
  col.schema.push({ name: 'quiz_id', type: 'relation', required: false, options: { collectionId: 'f0h63673w270x0o', cascadeDelete: true, maxSelect: 1 } });
  ...
  col.schema.push({ name: 'project_id', type: 'relation', required: false, options: { collectionId: 'o2uxt68v2w39a04', cascadeDelete: true, maxSelect: 1 } });
